...
class MainMenuView(Screen):
    def setup_ui(self):
        ...
        buttons = {"Games": self.callbacks['show_games'], "Leaderboard": self.callbacks['show_leaderboard'], "Affirmation": self.callbacks['show_affirmation'], "Joke": self.callbacks['show_joke']}
        row, col = 0, 0
